        ...
        <MainLayout admin={false}>
            <div className="container-fluid px-0" style={{ maxWidth: "1200px" }}>
                <header className="mb-4">
                    ...
                    <h2 className="fw-bold mt-1 mb-2">Cómo utilizar CRECUTEQ</h2>
                ...
                <section className="card border-0 shadow-sm mb-4">
                    <div className="card-body p-3 p-md-4">
                        ...
                        <p className="text-muted">
                            CRECUTEQ facilita la consulta de revistas científicas y la comparación de información proveniente de Scopus y SCImago, ayudando a identificar fuentes adecuadas para investigación, publicación y revisión bibliográfica.
                        </p>
                    </div>
                </section>
                ...
                <section className="card border-0 shadow-sm">
                    <div className="card-body p-3 p-md-4 d-flex flex-column flex-md-row justify-content-between gap-3 align-items-md-center">
                        <div>
                            ...
                            <p className="text-muted small">Para asistencia, comuníquese con el responsable institucional de CRECUTEQ o con el área de soporte tecnológico de su institución.</p>
                        </div>
