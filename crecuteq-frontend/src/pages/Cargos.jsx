...
function Cargos() {
    ...
    const cargarCargos = useCallback(async () => {
        ...
        try {
            ...
            notify("No se pudieron cargar los cargos.", "danger");
    ...
    const guardarCargo = async () => {
        ...
        try {
            ...
            notify(mensaje || "No se pudo guardar el cargo.", "danger");
    ...
    const confirmarEliminar = async () => {
        ...
        try {
            ...
            cerrarEliminar();
            notify(
                mensaje || "No se pudo eliminar el cargo. Verifique si está asociado a usuarios.",
                "danger"
            );
