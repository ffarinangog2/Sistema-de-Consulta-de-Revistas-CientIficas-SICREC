...
function Favoritos() {
    ...
    useEffect(() => {
        ...
        obtenerFavoritos(usuarioId)
            .then((data) => {
                if (activo) setFavoritos(Array.isArray(data) ? data : []);
            })
            .catch((error) => {
                console.error(error);
                if (activo) notify("No fue posible cargar sus favoritos.", "danger");
            });
            ...
            {favoritos.length === 0 ? (
                ...
                <div className="card shadow-sm border-0 mb-3">
                    <div className="card-body">
                        <label className="form-label" htmlFor="buscar-favoritos">Buscar en favoritos</label>
                        <div className="input-group">
                            <span className="input-group-text" aria-hidden="true">⌕</span>
                            <input id="buscar-favoritos" type="search" className="form-control"
                                placeholder="Buscar por título, revista, ISSN, cuartil o año"
                                value={busqueda}
                ...
                <div className="row g-4">
                    ...
                    {favoritosFiltrados.length === 0 ? (
                        <div className="col-12">
                            <div className="alert alert-info mb-0">No se encontraron favoritos.</div>
                        </div>
